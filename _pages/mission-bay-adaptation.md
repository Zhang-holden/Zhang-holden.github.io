---
layout: default
permalink: /projects/mission-bay-adaptation/
title: "Climate Adaptation Strategy for Mission Bay"
author_profile: true
---
...
**Coastal inundation** — marine flooding driven by tides, storm surges and sea-level rise (SLR), which may increase in frequency and extent as sea level rises. The analysis combines four storm-tide annual exceedance probability (AEP) levels with SLR scenarios from 0.5 m to 2.0 m.
...
<div style="text-align: center; margin: 20px 0;">
  <a href="/images/mission_bay_risk_matrix.png" target="_blank" title="Click to view full-size risk analysis matrix">
    <img src="/images/mission_bay_risk_matrix.png" alt="Risk Analysis Matrix" style="width: 65%; border: 1px solid #ddd; border-radius: 4px; cursor: zoom-in;">
  </a>
...
<div style="text-align: center; margin: 20px 0;">
  <a href="/images/mission_bay_adaptation_pathway.png" target="_blank" title="Click to view full-size adaptation pathway">
    <img src="/images/mission_bay_adaptation_pathway.png" alt="Adaptation Pathway" style="width: 85%; border: 1px solid #ddd; border-radius: 4px; cursor: zoom-in;">
  </a>
...
<div style="display: flex; flex-wrap: wrap; gap: 15px; margin-top: 20px; margin-bottom: 40px;">
  <a href="/files/projects/coursework/ENGGEN-726-climate-adaptation/Mission%20Bay%20Report.pdf" class="btn btn--danger" target="_blank"><i class="fas fa-file-pdf"></i> Project Report (PDF)</a>
  <a href="/files/projects/coursework/ENGGEN-726-climate-adaptation/Mission%20Bay%20Adaptation%20Strategy.pptx" class="btn btn--success" target="_blank"><i class="fas fa-file-powerpoint"></i> Presentation Slides</a>
</div>
