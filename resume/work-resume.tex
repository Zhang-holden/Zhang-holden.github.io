...
\noindent\textbf{数据分析与工程应用}：能够将数字化工具与工程业务有效融合，掌握 XML、XQuery 等数据管理技术，能熟练运用 Python 进行工程数据分析与处理，在成本优化与碳资产管理等领域有研究经验。

\vspace{0.25em}
\noindent\textbf{基础设施规划与评估}：熟悉相关 ISO 国际标准，能熟练应用全生命周期评估（LCA）及灾害情景模拟方法，结合具体场景开展基础设施的气候适应性分析与韧性规划。

\vspace{0.25em}
\noindent\textbf{沟通协作与外语能力}：具备跨文化交流与对外展示能力，可将英语作为工作语言；拥有真实企业合作场景下的团队协作与成果汇报经验。
...
\rinfo{编程与数据：Python（Pandas、Matplotlib等）、智能合约（Solidity）、XML、XPath、XQuery、LaTex。}
