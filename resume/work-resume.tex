...
\rinfo{高中写作与英语能力：具备跨文化交流与对外展示能力，可将英语作为工作语言；拥有真实企业合作场景下的团队协作与成果回报经验。}

\rinfo{数字化与成本优化：具备工程与数字化的交叉思维，能熟练运用 Python、智能合约等工具解决实际问题，在工程成本优化与碳资源管理等领域具有实操经验。}

\rinfo{基础设施规划与评估：熟练掌握全生命周期评估方法及灾害情景模拟方法，能结合具体场景开展基础设施的气候适应性分析与韧性规划。}
